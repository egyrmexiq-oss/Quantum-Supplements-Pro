...
if not st.session_state.usuario_activo:
    ...
    c = st.text_input("Clave de Acceso:Pronto dejará de funcionar la clave DEMO, si te interesa tener acceso Prefencial, envía WhatsApp al 333 220 32 61 con la palabra ACCESO..", type="password")
    if st.button("Entrar"):
